...
```
knowledge/
├── projects/          # 项目知识库（按项目组织）
│   ├── slp-go/
│   ├── slp-room/
│   ├── slp-starship/
│   └── slp-common-rpc/
├── patterns/          # 通用模式（跨项目最佳实践）
├── tools/             # 工具使用文档
├── cross-projects/    # 跨项目业务知识
...
**步骤**：
1. 进入项目目录 `projects/<project-name>/`
2. 按顺序阅读：
   - `01-structure.md` - 项目结构
   - `02-architecture.md` - 架构分层
   - `03-development.md` - 开发流程
   - `09-event-capabilities.md` - 事件能力清单

**快速入口**：
- [slp-go 学习路径](./projects/slp-go/01-structure.md)
- [slp-room 学习路径](./projects/slp-room/01-structure.md)
- [slp-starship 学习路径](./projects/slp-starship/01-structure.md)
- [slp-common-rpc 学习路径](./projects/slp-common-rpc/CORE_LEARNING.md)
