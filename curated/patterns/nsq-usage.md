...
| **HandleEventMap 路由** | 需动态扩展的复杂业务 | [[event-extension-guide.md]] 附录 A |
| **观察者模式** | 一个事件触发多个业务响应 | [[event-extension-guide.md]] 附录 B |
...
👉 **完整规范**: [[event-extension-guide.md]] 附录 A
...
| 文档 | 说明 |
|------|------|
| [[event-extension-guide.md]] | 事件拓展总纲（含完整示例） |
